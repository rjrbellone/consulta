                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <table id="example1" class="table table-hover table-bordered table-striped crud-table">
                            ...
                            <form action="formulario_insertar.php" method="POST" class="crud-form">
                                <tr>
                                    <td>
                                        <select class="form-select" style="width:100%" id="select-company" aria-label="Select Empresa" name="company"></select>
                                    </td>
                                    <td>
                                        <select class="form-select" style="width:100%" id="select-cost-center" aria-label="Select Centro de Costo" name="costCenter"></select>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" id="rut" name="rut" placeholder="XXXXXXXX-X">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" id="fullName" name="fullName" placeholder="Juanito Perez">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" id="transferRut" name="transferRut" placeholder="XXXXXXXX-X">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control" id="transferFullName" name="transferFullName" placeholder="Juanito Perez">
                                    </td>
                                    <td>
                                        <select class="form-select" style="width:100%" id="select-bank" aria-label="label select Banco" name="bank">
                                    ...
                                    <td>
                                        <select class="form-select" style="width:100%" id="select-account-type" aria-label="label select Tipo de Cuenta" name="accountType">
                                    ...
                                    <td>
                                        <input type="text" class="form-control" id="accountNumber" name="accountNumber" placeholder="1324131" name="accountNumber">
                                    </td>
                                    <td>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="lmarcelo@grupolosrobles.com">
                                    </td>
                                    <td colspan="2">
